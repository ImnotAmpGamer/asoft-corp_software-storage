...
local build_num0 = "d25w11_14d_f"

--Installer Version Manager
local ver1 = "v0.1b"
local build_type1 = "ALPHA"
local build_num1 = "r25w11_14d_f"
local dwloadStat = ""

--Setup
local isOSinstalled = false
local filesMoved = 1
local fileName = {"dPOS.lua", "dPOS-Logo.nfp", "dPOS-Logo_Small.nfp", "dPOS-SP.lua", "dPOS-ULP.lua", "dPOS-CP.lua", "dPOS-CFPr.lua", "dPOS-VerMgr.lua"}
local dnloadPath = "https://imnotampgamer.github.io/asoft-corp_software-storage/software/deltaPoint_OS/v0.1d-ALPHA-d25w11_14d_f/"
...
local function installOS()
    ...
    repeat
        ...
        print("Downloading files...["..dnloadedFiles.."/8]")
        ...
        sleep(0.5)
    until dnloadedFiles == 9
    if dnloadedFiles == 9 then
        dnloadStat = "success"
    else
        dnloadStat = "failed"
    end
    ...
    if dnloadStat == "success" then
        ...
        repeat
            print("Moving files...["..filesMoved.."/8]")
